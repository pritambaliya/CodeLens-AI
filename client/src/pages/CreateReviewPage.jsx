...
import { SUPPORTED_EXTENSIONS, SUPPORTED_LANGUAGES, MONACO_LANGUAGE_MAP } from '../utils/constants';
...
export default function CreateReviewPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const reviewId = data._id || data.id || data.review?._id || data.review?.id;
  ...
  return (
    <PageTransition className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 pb-16 pt-24 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">Create Code Review</h1>
          <p className="mt-1 text-text-muted">Submit your code for AI-powered analysis</p>
        </div>
